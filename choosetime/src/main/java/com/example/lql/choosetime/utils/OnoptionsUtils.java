package com.example.lql.choosetime.utils;

import android.content.Context;
import android.view.Gravity;
import android.view.View;

import com.example.lql.choosetime.pickerview.OptionsPopupWindow;
...
public class OnoptionsUtils {
     ...
     * @param listener
     */
    public static void showDateSelect(Context context, View view, int startYear,int startMonth,int startDay, int endYear,int endMonth,int endDay,TimePopupWindow.Type type,TimePopupWindow.OnTimeSelectListener listener) {
//        TimePopupWindow pop = new TimePopupWindow(context, TimePopupWindow.Type.YEAR_MONTH_DAY);
        TimePopupWindow pop = new TimePopupWindow(context,type,startYear,startMonth,startDay,endYear,endMonth,endDay);
