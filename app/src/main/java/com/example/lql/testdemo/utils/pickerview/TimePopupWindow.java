package com.example.lql.testdemo.utils.pickerview;
...
import com.example.lql.testdemo.utils.pickerview.lib.ScreenInfo;
import com.example.lql.testdemo.utils.pickerview.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
    public enum Type {
        ALL, YEAR_MONTH_DAY, HOURS_MINS, MONTH_DAY_HOUR_MIN ,YEAR_MONTH_DAY_HOURS
