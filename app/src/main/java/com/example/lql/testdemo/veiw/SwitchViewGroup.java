...
//        }
    ...
    private void invalidateText() {
        ...
        if (datas != null && datas.size() > 0) {
            firstTV.setText(datas.get(index % datas.size()).getNoticeTitle());
            secondTV.setText(datas.get((index + 1) % datas.size()).getNoticeTitle());
        }
...
//        }
    ...
    public void addData(NoticeBean data) {
        datas.add(data);
    }

    public void addData(List<NoticeBean> data) {
        datas.addAll(data);
    }
